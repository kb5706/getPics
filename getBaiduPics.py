...
for n in range (1,int(pagenum)):

    url = 'http://image.baidu.com/search/flip?tn=baiduimage&ie=utf-8&word='+keyword+'&pn=str(pagenum*20)&gsm=64&ct=&ic=0&lm=-1&width=0&height=0'
